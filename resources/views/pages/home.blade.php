    ...
    <section class="posts container">
		...
		<figure><img src="{{$post->photos->first()->url}}" alt="" class="img-responsive" width="100%"></figure>
			@elseif($post->photos->count() > 1)

			<div class="gallery-photos" data-masonry='{ "itemSelector": ".grid-item", "columnWidth": 465 }' >
			...
			<div class="content-post">
				...
				<footer class="container-flex space-between">
					...
					<span class="tag c-gray-1 text-capitalize" style="color: gray;"> <a href="{{route('tags.show',$tag)}}">#{{ $tag->name }}</a></span>
							@endforeach
					</div>
				</footer>
			</div>
